    ...
    <body>
        ...
        <div class="container">
            <div class="header clearfix">
                <h3 class="text-muted" style="text-align: center;">Nạp E tiền</h3>
            </div>
            <h3 class="hide">Tạo mới đơn hàng</h3>
            <div class="table-responsive">
                <form action="./vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <button type="submit" class="btn btn-primary hide" id="btnPopup">Thanh toán Post</button>
                    <button type="submit" name="redirect" id="redirect" class="btn btn-default" style="text-align: center; display: block; margin: 0 auto; width: 200px; background-color: #3366ff; border-color: #3366ff; color: #fff;">
Xác nhận
</button>
